/*
// Description: This file describes the vec3 data structure to be used throughout application.
//              It describes a struct of 3 independent data points in space (x, y, z) to be 
//              used for describing the location of pixels, objects, or colors of other stuctures.
//              It can be accessed as vec3, point3 or color. Each point in the 3-wide vector is 
//              a f32 data type. Methods have been created for operations on and between different
//              3-wide vectors, as well as different initializations methods for randomly generating
//              points.
*/
